 ...
 * ==========================================================<br>
 */
public class XBGTVarietyPresenter extends BaseVarietyInfoPresenter {

    public XBGTVarietyPresenter(BaseActivity baseActivity, BaseFragment baseFragment, RefreshRecyclerView iView) {
