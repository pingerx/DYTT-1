...
public class Const {
    ...
    public static final String COUNTRY = "产地";
    public static final String CATEGORY = "类别";
    public static final String LANGUAGE = "语言";
    public static final String DURATION = "片长";
    public static final String DIRECTOR = "导演";
    public static final String LEADING_ROLE = "主演";
    ...
    public static final String IMDB_GRADE = "IMDb评分";
    public static final String DOUBAN_GRADE = "豆瓣评分";
    ...
    // 游戏
    public static final String GAME_NAME = "中文名称";
