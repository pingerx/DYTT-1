 ...
 * ==========================================================<br>
 */
public class HPTvFragment extends RefreshRecyclerFragment implements BaseTvInfoIView {

    public static HPTvFragment newInstance() {
        Bundle args = new Bundle();
        HPTvFragment fragment = new HPTvFragment();
    ...
    protected RefreshRecyclerPresenter initRefreshRecyclerPresenter() {
        return new HPTvPresenter(getBaseActivity(), this, this);
    }
}
