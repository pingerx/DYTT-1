 ...
 * ==========================================================<br>
 */
public class JSKFilmPresenter extends BaseInfoPresenter {

    public JSKFilmPresenter(BaseActivity baseActivity, BaseFragment baseFragment, RefreshRecyclerView iView) {
