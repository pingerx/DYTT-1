 ...
 * ==========================================================<br>
 */
public class EAFilmPresenter extends BaseInfoPresenter {


    public EAFilmPresenter(BaseActivity baseActivity, BaseFragment baseFragment, RefreshRecyclerView iView) {
