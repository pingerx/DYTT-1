 ...
 * ==========================================================<br>
 */
public class HYComicPresenter extends BaseComicInfoPresenter {

    public HYComicPresenter(BaseActivity baseActivity, BaseFragment baseFragment, RefreshRecyclerView iView) {
    ...
    public Observable<ArrayList<BaseInfoEntity>> getRequestListDataObservable(String nextPage) {
        return Repository.getInstance().getHYComic(Integer.valueOf(nextPage));
    }
