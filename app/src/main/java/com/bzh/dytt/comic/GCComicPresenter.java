 ...
 * ==========================================================<br>
 */
public class GCComicPresenter extends BaseComicInfoPresenter {

    public GCComicPresenter(BaseActivity baseActivity, BaseFragment baseFragment, RefreshRecyclerView iView) {
    ...
    public Observable<ArrayList<BaseInfoEntity>> getRequestListDataObservable(String nextPage) {
        return Repository.getInstance().getGCComic(Integer.valueOf(nextPage));
    }
