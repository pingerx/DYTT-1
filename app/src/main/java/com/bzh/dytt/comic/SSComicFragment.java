 ...
 * ==========================================================<br>
 */
public class SSComicFragment extends RefreshRecyclerFragment implements BaseComicInfoIView {

    public static SSComicFragment newInstance() {
        Bundle args = new Bundle();
        SSComicFragment fragment = new SSComicFragment();
    ...
    protected RefreshRecyclerPresenter initRefreshRecyclerPresenter() {
        return new SSComicPresenter(getBaseActivity(), this, this);
    }
}
