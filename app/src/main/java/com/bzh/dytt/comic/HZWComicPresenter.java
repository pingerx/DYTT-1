 ...
 * ==========================================================<br>
 */
public class HZWComicPresenter extends BaseComicInfoPresenter {

    public HZWComicPresenter(BaseActivity baseActivity, BaseFragment baseFragment, RefreshRecyclerView iView) {
    ...
    public Observable<ArrayList<BaseInfoEntity>> getRequestListDataObservable(String nextPage) {
        return Repository.getInstance().getHZWComic(Integer.valueOf(nextPage));
    }
