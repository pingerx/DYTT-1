 ...
 * ==========================================================<br>
 */
public class DMComicFragment extends RefreshRecyclerFragment implements BaseComicInfoIView {

    public static DMComicFragment newInstance() {
        Bundle args = new Bundle();
        DMComicFragment fragment = new DMComicFragment();
    ...
    protected RefreshRecyclerPresenter initRefreshRecyclerPresenter() {
        return new DMComicPresenter(getBaseActivity(), this, this);
    }
}
