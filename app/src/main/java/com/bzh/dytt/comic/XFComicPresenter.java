 ...
 * ==========================================================<br>
 */
public class XFComicPresenter extends BaseComicInfoPresenter {

    public XFComicPresenter(BaseActivity baseActivity, BaseFragment baseFragment, RefreshRecyclerView iView) {
    ...
    public Observable<ArrayList<BaseInfoEntity>> getRequestListDataObservable(String nextPage) {
        return Repository.getInstance().getNewComic(Integer.valueOf(nextPage));
    }
