 ...
 * ==========================================================<br>
 */
public class QTComicPresenter extends BaseComicInfoPresenter {

    public QTComicPresenter(BaseActivity baseActivity, BaseFragment baseFragment, RefreshRecyclerView iView) {
    ...
    public Observable<ArrayList<BaseInfoEntity>> getRequestListDataObservable(String nextPage) {
        return Repository.getInstance().getOtherComic(Integer.valueOf(nextPage));
    }
