 ...
 * ==========================================================<br>
 */
public class SSComicPresenter extends BaseComicInfoPresenter {

    public SSComicPresenter(BaseActivity baseActivity, BaseFragment baseFragment, RefreshRecyclerView iView) {
    ...
    public Observable<ArrayList<BaseInfoEntity>> getRequestListDataObservable(String nextPage) {
        return Repository.getInstance().getSSComic(Integer.valueOf(nextPage));
    }
