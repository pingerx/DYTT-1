 ...
 * ==========================================================<br>
 */
public class DMComicPresenter extends BaseComicInfoPresenter {

    public DMComicPresenter(BaseActivity baseActivity, BaseFragment baseFragment, RefreshRecyclerView iView) {
    ...
    public Observable<ArrayList<BaseInfoEntity>> getRequestListDataObservable(String nextPage) {
        return Repository.getInstance().getComic(Integer.valueOf(nextPage));
    }
