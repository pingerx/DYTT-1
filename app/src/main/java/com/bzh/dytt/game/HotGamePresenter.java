 ...
 * ==========================================================<br>
 */
public class HotGamePresenter extends BaseGameInfoPresenter {

    public HotGamePresenter(BaseActivity baseActivity, BaseFragment baseFragment, RefreshRecyclerView iView) {
    ...
    public Observable<ArrayList<BaseInfoEntity>> getRequestListDataObservable(String nextPage) {
        return Repository.getInstance().getHotGame(Integer.valueOf(nextPage));
    }
