 ...
 * ==========================================================<br>
 */
public class ClassicGameFragment extends RefreshRecyclerFragment implements BaseGameInfoIView {
    ...
    protected RefreshRecyclerPresenter initRefreshRecyclerPresenter() {
        return new ClassicGamePresenter(getBaseActivity(), this, this);
    }
}
