 ...
 * ==========================================================<br>
 */
public class ClassicGamePresenter extends BaseGameInfoPresenter {

    public ClassicGamePresenter(BaseActivity baseActivity, BaseFragment baseFragment, RefreshRecyclerView iView) {
    ...
    public Observable<ArrayList<BaseInfoEntity>> getRequestListDataObservable(String nextPage) {
        return Repository.getInstance().getClassicGame(Integer.valueOf(nextPage));
    }
